...
theme = pygame.mixer.music.load('music/boss T.mp3')
...
dialog1 = pygame.mixer.Sound('music/AUDIOS FINAL/FINAL.mp3')
	...
	for i in range(num_of_frames):
		...
		if player_hits >= 12:
			...
			if counter_dialog == 0:
				...
				dialog1.play()
				time.sleep(1)
				dialog('TESLA FUE UN GRANDIOSO INVENTOR, QUE CONSIGUIO', 13, (200, 360), (255, 255, 255))
				dialog('CAMBIAR LA ELECTRICIDAD MODERNA, UN INVENTOR', 13, (200, 410), (255, 255, 255))
				dialog('QUE SIEMPRE TUVO BUENAS IDEAS Y LO CONSIGUIO', 13, (200, 460), (255, 255, 255))
				dialog('CASI TODO, A PARTIR DE ESTO MOMENTO COMENZARA', 11, (200, 510), (255, 255, 255))
				screen.blit(AUDIOIMG, (0, -90))
				dialog('EL DECLIVE DE TESLA, TERMINARA ARRUINADO Y SOLO,', 11, (200, 360), (255, 255, 255))
				dialog('PERO SUS VALORES Y SUENOS SON EL MEJOR RECUERDO', 11, (200, 410), (255, 255, 255))
				dialog('QUE PODEMOS TENER, UNA PERSONA QUE TRABAJABA', 11, (200, 460), (255, 255, 255))
				dialog(' POR EL BIEN COMUN Y NO POR EL PARTICULAR,', 11, (200, 510), (255, 255, 255))
				screen.blit(AUDIOIMG, (0, -90))
				dialog(' ESE ES EL FIN DE LA ENCICLOPEDIA', 11, (200, 360), (255, 255, 255))
				counter_dialog += 1
				time.sleep(2)
				pygame.quit()
				subprocess.call(["python", "Cinematic final.py"])

...
theme = pygame.mixer.music.load('music/bossm.mp3')
...
dialog1 = pygame.mixer.Sound('music/AUDIOS FINAL/RADIO OBTENIDO.mp3')
	...
	for i in range(num_of_frames):
		...
		if player_hits >= 12:
			...
			if counter_dialog == 0:
				...
				dialog1.play()
				time.sleep(1)
				dialog('PERFECTO HAZ OBTENIDO EL RADIO', 13, (200, 400), (255, 255, 255))
				dialog('AHORA SI, VAMONOS', 13, (200, 450), (255, 255, 255))
				counter_dialog += 1
				time.sleep(2)
				pygame.quit()

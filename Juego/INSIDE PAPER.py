...
#music
pygame.mixer.music.load('music/PAPER INSIDE.mp3')
...
while run:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_x and pygame.sprite.groupcollide(player_group, coins_group, False, True):
                mixer.music.pause()
                pygame.quit()
                subprocess.call(["python", "NPC- HOUSE 2.py"])

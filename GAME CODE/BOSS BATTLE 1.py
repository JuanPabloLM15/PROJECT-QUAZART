...
theme = pygame.mixer.music.load('music/BOSSN.mp3')
...
dialog1 = pygame.mixer.Sound('music/AUDIOS FINAL/NEWTON FINAL.mp3')
...
while run:
	...
	for i in range(num_of_frames):
		...
		if player_life >= 12:
			...
			pygame.quit()
			subprocess.call(["python", "OLDTOWN.py"])
		if player_hits >= 12:
			...
			if counter_dialog == 0:
				...
				dialog1.play()
				time.sleep(1)
				dialog('BIEN HECHO, 2/2 CADA VEZ MAS CERCA DE ', 13, (200, 400), (255, 255, 255))
				dialog('COMPLETAR LA ENCICLOPEDIA, TIEMPO... ', 13, (200, 450), (255, 255, 255))
				dialog('NEWTON ME DIO UNA GRANDIOSA IDEA ', 13, (200, 500), (255, 255, 255))
				time.sleep(3)
				counter_dialog += 1
				pygame.quit()
				subprocess.call(["python", "RPGSTILE.py"])

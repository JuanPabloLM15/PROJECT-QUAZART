...
theme = pygame.mixer.music.load('music/BOSSP.mp3')
...
dialog1 = pygame.mixer.Sound('music/AUDIOS FINAL/LONDRES.mp3')
...
while run:
	...
	for i in range(num_of_frames):
		...
		if player_life >= 12:
			...
			pygame.quit()
			subprocess.call(["python", "CAMINO PITAGORAS.py"])
		if player_hits >= 12:
			...
			if counter_dialog == 0:
				...
				dialog1.play()
				time.sleep(1)
				dialog('MUY BIEN HECHO, CREO QUE LA SIGUIENTE EPOCA ', 13, (200, 400), (255, 255, 255))
				dialog('TE ENCANTARA, ¿CONOCES LONDRES? ', 13, (200, 450), (255, 255, 255))
				counter_dialog += 1
				pygame.quit()
